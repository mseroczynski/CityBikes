...
import pl.ches.citybikes.mvp.common.base.MvpLceUtil
 ...
 */
abstract class BaseLceViewStateFragmentSrl<CV : SwipeRefreshLayout, M, V : HostedMvpLceView<M>, P : MvpPresenter<V>> : BaseLceViewStateFragment<CV, M, V, P>() {
