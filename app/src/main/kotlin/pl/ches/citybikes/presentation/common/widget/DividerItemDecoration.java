...
/**
 * Note: this is modified version of https://gist.github.com/zokipirlo/82336d89249e05bba5aa
 *
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
  ...
  private int mLeftPaddingInPx, mRightPaddingInPx;
  ...
  public void setLeftPaddingInPx(int leftPaddingInPx) {
    mLeftPaddingInPx = leftPaddingInPx;
  }

  public void setRightPaddingInPx(int rightPaddingInPx) {
    mRightPaddingInPx = rightPaddingInPx;
  }
  ...
  public void onDrawOver(Canvas c, RecyclerView parent, RecyclerView.State state) {
    ...
    if (orientation == LinearLayoutManager.VERTICAL) {
      ...
      if (mLeftPaddingInPx > 0) {
        left += mLeftPaddingInPx;
      }
      if (mRightPaddingInPx > 0) {
        right -= mRightPaddingInPx;
      }
    } else { //horizontal
